...
class RestaurantTest {
    ...
    public void is_restaurant_open_should_return_true_if_time_is_between_opening_and_closing_time(){
        ...
        // use mockito for mocking currentTime
    ...
    public void is_restaurant_open_should_return_false_if_time_is_outside_opening_and_closing_time(){
        ...
        // use mockito for mocking currentTime
        Restaurant mockedRestaurant = Mockito.spy(restaurant);
        Mockito.when(mockedRestaurant.getCurrentTime()).thenReturn(LocalTime.parse("00:30:00"));
    ...
    @Test
    public void added_items_should_return_correct_order_value(){
        ...
        int result = restaurant.calculateTotalPriceForOrder(selectedItemNames);
